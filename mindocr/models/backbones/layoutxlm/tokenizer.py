# Copyright (c) 2021 MindSpore Authors. All Rights Reserved.
...
from .tokenizer_utils import PretrainedTokenizer, _is_control, _is_punctuation, _is_whitespace
    ...
    pretrained_resource_files_map = {
        "vocab_file": {
            "layoutxlm-base-uncased":
                "https://download.mindspore.cn/toolkits/mindocr/vi_layoutxlm/sentencepiece.bpe.model",
        }
    }
